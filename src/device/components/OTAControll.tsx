...
export const renderOTAControl = (loading: boolean, isConnected: boolean, otaProgress: OTAProgress | null, setShowOTAModal: (show: boolean) => void) => (
...
export const renderOTAModal = (showOTAModal: boolean, setShowOTAModal: (show: boolean) => void, startOTAUpdate: () => void, loading: boolean, refresh: boolean, otaLoading: boolean) => {
